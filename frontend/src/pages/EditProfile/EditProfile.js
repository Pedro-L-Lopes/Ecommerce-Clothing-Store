...
//   // Carregando dados do usuário // vão para a variavel user importado com o useSelector
//   useEffect(() => {
//     dispatch(profile());
//   }, [dispatch]);
...
//     // Pegando states do usuário para poder atualizar
//     const userData = {
//       name,
//     };
...
//     const formData = new FormData(); // Instancia um novo objeto para jogar as coisas que tenho dentro dele

//     // Fazendo loop em todas as chaves que forem enviadas
//     const userFormData = Object.keys(userData).forEach(
//       (key) => formData.append(key, userData[key]) // Colocando a chave em cada um dos itens
//     );

//     console.log(formData);
//     formData.append("user", userFormData); // Passar um objeto chamado usuário em todos os dados do loop
...
//       {/* Checa se o usuário tem uma imagem ou se o previewImage mudou o dado que começa "" */}
//       {(user.profileImage || previewImage) && (
//         <img
//           className="profile-image" // Exibir ou a imagem de perfil ou preview
//           src={
//             // Prioridade para o previewImage
//             previewImage
//               ? URL.createObjectURL(previewImage) // Gerando imagem temporaria (entre o meu pc e o server)
